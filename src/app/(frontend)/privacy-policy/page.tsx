      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8">
          <p className="text-gray-700">
            This Privacy Notice for leadsplays ("we," "us," or "our"), describes
          ...
          <ul className="list-disc list-inside mt-4 text-gray-700">
            <li>
              ...
              <a
                href="http://www.leadsplays.com"
                className="text-blue-600 hover:underline"
              >
                http://www.leadsplays.com
              </a>{" "}
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700">
              ...
              <a
                href="https://leadsplays.com/consent"
                className="text-blue-600 hover:underline"
              >
                leadsplays.com/consent
              </a>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700">Review the Privacy Notice in full.</p>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            <h5 className="font-semibold text-gray-900 mb-2">Device Data.</h5>
            <p className="text-gray-700">
        ...
        <h4 className="text-lg font-semibold text-gray-900 mb-3">Google API</h4>
        ...
        <p className="text-gray-700 mb-4">
          ...
          security and fraud prevention, and to comply with law. We process the
          personal information for the following purposes listed below. We may
          also process your information for other purposes only with your prior
          explicit consent.
        </p>
        <p className="text-gray-700 mb-6">
        ...
        <p className="text-gray-700 mb-6">
          ...
          from users less than 18 years of age or the equivalent age as
          specified by law in your jurisdiction has been collected, we will
        ...
        <p className="text-gray-700 mb-6">
          ...
          , by visiting{" "}
          <a
            href="http://www.leadsplays.com/contact"
            className="text-blue-600 hover:underline"
          >
            http://www.leadsplays.com/contact
          </a>
        ...
        <h4 className="text-lg font-semibold text-gray-900 mb-3">Appeals</h4>
        <p className="text-gray-700 mb-6">
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-8">
          ...
          <p className="text-gray-700">casablanca, casablanca-settat 20200</p>
