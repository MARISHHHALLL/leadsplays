  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="prose prose-lg max-w-none">
        ...
        <p className="text-gray-600 mb-8">Last updated September 14, 2025</p>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            We are leadsplays ("Company," "we," "us," "our"), a company
            registered in Morocco at Riad oulfa casablanca, casablanca, Grand
            casablanca 20200.
          </p>
          <p className="text-gray-700 mb-4">
            We operate the website{" "}
            <a
              href="https://www.leadsplays.com"
              className="text-blue-600 hover:underline"
            >
              https://www.leadsplays.com
            </a>{" "}
          ...
          <p className="text-gray-700 mb-4">
            ...
            , email at{" "}
            <a
              href="mailto:contact@leadsplays.com"
              className="text-blue-600 hover:underline"
            >
              contact@leadsplays.com
            </a>
            , or by mail to Riad oulfa casablanca, casablanca, Grand casablanca
            20200, Morocco.
          </p>
          <p className="text-gray-700 mb-4">
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and leadsplays, concerning your access to and use of the Services.
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li>MISCELLANEOUS</li>
            <li>DISCLAIMER ON ADDITIONAL CLAUSES</li>
            <li>CONTACT US</li>
          </ol>
        </div>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4 ml-6">
        ...
        <p className="text-gray-700 mb-8">
          ...
          Policy:{" "}
          <a
            href="http://www.leadsplays.com/privacy-policy"
            className="text-blue-600 hover:underline"
          >
            http://www.leadsplays.com/privacy-policy
          </a>
          ...
          Services are hosted in Morocco. If you access the Services from any
          ...
          applicable laws in Morocco, then through your continued use of the
          Services, you are transferring your data to Morocco, and you expressly
          consent to have your data transferred to and processed in Morocco.
        </p>
        ...
        <p className="text-gray-700 mb-8">
          ...
          of Morocco. leadsplays and yourself irrevocably consent that the
          courts of Morocco shall have exclusive jurisdiction to resolve any
        ...
        <p className="text-gray-700 mb-6">
          ...
          casablanca, Morocco. The language of the proceedings shall be english.
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">
          26. DISCLAIMER ON ADDITIONAL CLAUSES
        </h2>
        <p className="text-gray-700 mb-8">
          This section is provided solely for informational and customization
          purposes. It does not constitute legal advice and should not be relied
          upon as such. By adding or modifying any additional clause, you
          acknowledge and agree that: You are solely responsible for the
          accuracy, legality, and enforcement of the clause under all applicable
          laws and regulations. The website, its owners, and affiliates assume
          no liability for errors, omissions, or consequences resulting from
          your use or reliance on any additional clause. You understand that
          consultation with a qualified attorney is strongly recommended prior
          to including or relying on any additional clause. By including an
          additional clause, you release and hold harmless the website, its
          owners, and affiliates from any claims, damages, liabilities, costs,
          or legal actions that may arise, directly or indirectly, from the
          inclusion, omission, or interpretation of such clause.
        </p>
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          <p className="text-gray-700 font-semibold">leadsplays</p>
          <p className="text-gray-700">Riad oulfa casablanca</p>
          <p className="text-gray-700">casablanca, Grand casablanca 20200</p>
          <p className="text-gray-700">Morocco</p>
          <p className="text-gray-700">
            Phone:{" "}
            <a
              href="tel:+212619962564"
